...
<script type="text/javascript">
       function shanchu(id){
    	   ...
    	   if(confirm_){
    	   $.ajax({
			   url:"<%=contextPath%>/philosophy/"+id, 
		       type:'delete',
		       contentType:'application/json',
		       success:function(data){
		    	   if(data==true){
			             window.location.href="<%=contextPath%>/philosophy/philosophyManage"
			         }else{
       ...
       function chaxun(){
    	   ...
    	   $.ajax({
			   url:"<%=contextPath%>/student/selectHwById?searchcontent="+searchcontent, 
		       type:'GET',
		       contentType:'application/json',
		       success:function(data){
		         alert("成功啦"); 
