...
<script type="text/javascript">
       function shanchu(id){
    	   ...
    	   if(confirm_){
    	   $.ajax({
			   url:"<%=contextPath%>/web/philosophy/"+id, 
		       type:'delete',
		       contentType:'application/json',
		       success:function(data){
		    	   if(data==true){
			             window.location.href="<%=contextPath%>/web/philosophy/philosophyManage"
			         }else{
       ...
       function xiugai(id,title,content){
    	   $("#id").val(id);
    	   $("#title").val(title);
    	   $("#content").val(content);
       ...
       function insert(){
    	   var data= $('#philosophyInsert').serializeArray();
    	   $.ajax({
			   url:"<%=contextPath%>/web/philosophy", 
		       type:'post',
		       dateType:'json',
		       data:data,
		       success:function(data){
       ...
       function update(){
           var data=$('#philosophyUpdate').serialize();
    	   $.ajax({
			   url:"<%=contextPath%>/web/philosophy", 
		       type:'put',
		       dateType:'json',
...
<body>
	...
	<!--end of 头部导航-->
		...
		<div class="body">
			<div class="body-left">
				<ul>
				    <li style="font-size:20px;padding-left:20px" class="user"><p style="background:orange"><a href="<%=contextPath%>/web/president/presidentManage">总统管理</a></p></li>
				    <li style="font-size:20px;padding-left:20px" class="user"><p style="background:orange"><a href="<%=contextPath%>/web/emperor/emperorManage">皇帝管理</a></p></li>
				    <li style="font-size:20px;padding-left:20px" class="user"><p style="background:orange"><a href="<%=contextPath%>/web/philosophy/philosophyManage">哲学管理</a></p></li>
				    <li style="font-size:20px;padding-left:20px" class="user"><p style="background:orange"><a href="<%=contextPath%>/web/picture/pictureManage">图片管理</a></p></li>
				    <li style="font-size:20px;padding-left:20px" class="user"><p style="background:orange"><a href="<%=contextPath%>/web/quote/quoteManage">名言管理</a></p></li>
			    </ul>
			</div>
			  	...
			  	<div id="searchDiv" class="row">
					...
					<div style="padding-left: 960px;">
						<button style="width: 120px;" class="btn btn-primary btn-lg"
							data-toggle="modal" data-target="#myInsertModal">添加哲学</button>
					</div>
	                            ...
	                            %>
									<tr>
										...
										<td style="width: 50px"><button style="width: 120px;"
												class="btn btn-primary btn-lg" onclick="xiugai('<%=p.getId()%>','<%=p.getTitle()%>','<%=p.getContent()%>')">修改</button></td>
										<td style="width: 50px"><button style="width: 120px"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">增加哲学信息</h4>
					</div>
					<div class="modal-body">
						<!-- 添加的方法 -->
						<form class="form-horizontal" id="philosophyInsert" onsubmit="return false">
							<div class="form-group">	
								<label for="lastname" class="col-sm-2 control-label">哲学标题</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="lastname" class="col-sm-2 control-label">哲学内容</label>
								<div class="col-sm-4">
		...
		<div class="modal fade" id="myUpdateModal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<!-- 更新的方法 -->
						<form class="form-horizontal" id="philosophyUpdate" onsubmit="return false">
							<div class="form-group">
